---
title: Examples
description: Runnable holos stacks and templates.
permalink: /examples/
---

# Examples

Each example is a complete `holos.yaml` you can copy or run with `-f`. They are
intentionally small and show one idea at a time.
...
View the source examples on
[GitHub](https://github.com/zeroecco/holos/tree/main/examples).
