...
var Registry = []Image{
	...
	{Name: "arch", Tag: "latest", URL: "https://geo.mirror.pkgbuild.com/images/v20260515.530093/Arch-Linux-x86_64-cloudimg-20260515.530093.qcow2", Format: "qcow2", Default: true, User: "arch", OSFamily: "systemd", SHA256URL: "https://geo.mirror.pkgbuild.com/images/v20260515.530093/Arch-Linux-x86_64-cloudimg-20260515.530093.qcow2.SHA256"},
	...
	// only ~25 MB larger.
	{Name: "debian", Tag: "12", URL: "https://cloud.debian.org/images/cloud/bookworm/20260518-2482/debian-12-generic-amd64-20260518-2482.qcow2", Format: "qcow2", Default: true, User: "debian", OSFamily: "systemd", SHA512URL: "https://cloud.debian.org/images/cloud/bookworm/20260518-2482/SHA512SUMS"},
	{Name: "debian", Tag: "bookworm", URL: "https://cloud.debian.org/images/cloud/bookworm/20260518-2482/debian-12-generic-amd64-20260518-2482.qcow2", Format: "qcow2", User: "debian", OSFamily: "systemd", SHA512URL: "https://cloud.debian.org/images/cloud/bookworm/20260518-2482/SHA512SUMS"},
	{Name: "debian", Tag: "13", URL: "https://cloud.debian.org/images/cloud/trixie/20260518-2482/debian-13-generic-amd64-20260518-2482.qcow2", Format: "qcow2", User: "debian", OSFamily: "systemd", SHA512URL: "https://cloud.debian.org/images/cloud/trixie/20260518-2482/SHA512SUMS", RequiresVGA: true},
	{Name: "debian", Tag: "trixie", URL: "https://cloud.debian.org/images/cloud/trixie/20260518-2482/debian-13-generic-amd64-20260518-2482.qcow2", Format: "qcow2", User: "debian", OSFamily: "systemd", SHA512URL: "https://cloud.debian.org/images/cloud/trixie/20260518-2482/SHA512SUMS", RequiresVGA: true},
	...
	{Name: "ubuntu", Tag: "noble", URL: "https://cloud-images.ubuntu.com/noble/20260323/noble-server-cloudimg-amd64.img", Format: "qcow2", Default: true, User: "ubuntu", OSFamily: "systemd", SHA256URL: "https://cloud-images.ubuntu.com/noble/20260323/SHA256SUMS"},
	{Name: "ubuntu", Tag: "24.04", URL: "https://cloud-images.ubuntu.com/noble/20260323/noble-server-cloudimg-amd64.img", Format: "qcow2", User: "ubuntu", OSFamily: "systemd", SHA256URL: "https://cloud-images.ubuntu.com/noble/20260323/SHA256SUMS"},
	{Name: "ubuntu", Tag: "resolute", URL: "https://cloud-images.ubuntu.com/resolute/20260421/resolute-server-cloudimg-amd64.img", Format: "qcow2", User: "ubuntu", OSFamily: "systemd", SHA256URL: "https://cloud-images.ubuntu.com/resolute/20260421/SHA256SUMS"},
	{Name: "ubuntu", Tag: "26", URL: "https://cloud-images.ubuntu.com/resolute/20260421/resolute-server-cloudimg-amd64.img", Format: "qcow2", User: "ubuntu", OSFamily: "systemd", SHA256URL: "https://cloud-images.ubuntu.com/resolute/20260421/SHA256SUMS"},
	{Name: "ubuntu", Tag: "26.04", URL: "https://cloud-images.ubuntu.com/resolute/20260421/resolute-server-cloudimg-amd64.img", Format: "qcow2", User: "ubuntu", OSFamily: "systemd", SHA256URL: "https://cloud-images.ubuntu.com/resolute/20260421/SHA256SUMS"},
	{Name: "ubuntu", Tag: "jammy", URL: "https://cloud-images.ubuntu.com/jammy/20260320/jammy-server-cloudimg-amd64.img", Format: "qcow2", User: "ubuntu", OSFamily: "systemd", SHA256URL: "https://cloud-images.ubuntu.com/jammy/20260320/SHA256SUMS"},
	{Name: "ubuntu", Tag: "22.04", URL: "https://cloud-images.ubuntu.com/jammy/20260320/jammy-server-cloudimg-amd64.img", Format: "qcow2", User: "ubuntu", OSFamily: "systemd", SHA256URL: "https://cloud-images.ubuntu.com/jammy/20260320/SHA256SUMS"},
	...
	// times during publisher rotations.
	{Name: "almalinux", Tag: "10", URL: "https://repo.almalinux.org/almalinux/10/cloud/x86_64/images/AlmaLinux-10-GenericCloud-10.1-20260518.0.x86_64.qcow2", Format: "qcow2", Default: true, User: "almalinux", OSFamily: "systemd", SHA256URL: "https://repo.almalinux.org/almalinux/10/cloud/x86_64/images/CHECKSUM"},
