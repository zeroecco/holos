...
var Registry = []Image{
	...
	{Name: "ubuntu", Tag: "26", URL: "https://cloud-images.ubuntu.com/resolute/current/resolute-server-cloudimg-amd64.img", Format: "qcow2", User: "ubuntu", OSFamily: "systemd", SHA256URL: "https://cloud-images.ubuntu.com/resolute/current/SHA256SUMS"},
